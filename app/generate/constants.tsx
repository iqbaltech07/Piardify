...
export const TECH_CATEGORIES = [
  ...
  },
  {
    ...
    options: ["Node.js", "Python (FastAPI/Django)", "Laravel", "NestJS", "Spring Boot", "Go"],
  },
  {
    ...
    options: ["PostgreSQL", "MySQL", "MongoDB", "Supabase", "Firebase", "Redis"],
  },
  {
    ...
    options: ["Vercel", "AWS", "Google Cloud", "Azure", "Railway", "Docker"],
  }
];

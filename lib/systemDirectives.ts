export const SYSTEM_DIRECTIVES = {
  "systemDirectives": {
    ...
    "antiHallucinationRules": {
      ...
      "selfCheckPrompt": "Sebelum mengirim output, tanyakan pada diri sendiri: 'Apakah saya menambah sesuatu yang tidak ada di PRD? Apakah saya mengasumsikan sesuatu yang tidak terdokumentasi?'"
    },
